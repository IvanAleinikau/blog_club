...
class _$_SplashState implements _SplashState {
  _$_SplashState({this.isLoaded = false});
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(isLoaded));
...
abstract class _SplashState implements SplashState {
  factory _SplashState({final bool isLoaded}) = _$_SplashState;
